...
namespace Pennyworth.Helpers {
    ...
    public static class SerializationHelper {
        /// <summary>
        /// Serializes data of type <c>T</c> to file at <c>path </c> using <c>type</c> formatter
        /// </summary>
        ...
        /// <returns>true if <c>source</c> has been persisted; false otherwise</returns>
        ...
        /// <summary>
        /// Deserializes data of type <c>T</c> from file at <c>path </c> using <c>type</c> formatter
        /// </summary>
        /// <typeparam name="T">type to deserialize</typeparam>
        /// <param name="path">path to file to store the data</param>
        /// <param name="type">determines the formatter to use</param>
        /// <returns>Object of <c>T</c> on success; <c>null</c> otherwise</returns>
